...
test_img2 = cv2.imread('testing_matched/2024-03-21 11.30.03.jpg')
test_img2 = cv2.resize(test_img2, (256, 256))

# Convert to NumPy arrays
test_img2 = np.asarray(test_img2)

# Reshape to match the expected shape for imshow
test_img2 = test_img2.reshape(256, 256, 3)

# Predict using the model
p2 = model.predict(test_img2.reshape(-1, 256, 256, 3))

# Display the second image and its prediction
plt.imshow(test_img2)
plt.title(labels[np.argmax(p2)])
plt.show()